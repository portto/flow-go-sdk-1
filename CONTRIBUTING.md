# Contributing to the Flow Go SDK

The following is a set of guidelines for contributing to the Flow Go SDK.
...
- [Good first issues](https://github.com/portto/blocto-flow-go-sdk/labels/good%20first%20issue):
  issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/portto/blocto-flow-go-sdk/labels/help%20wanted):
...
Thank you for your interest in contributing to the Flow Go SDK!
